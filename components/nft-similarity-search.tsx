        ...
        <div className="space-y-4">
          ...
          {isSearching && (
            <div className="space-y-2">
              ...
              <p className="text-sm text-center text-muted-foreground">데이터베이스에서 NFT를 검색하고 있습니다...</p>
            </div>
          )}
        </div>
              ...
              <Card key={nft.nftId} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-3">
                  ...
                  {nft.assetUrl && (
                    <div className="w-full h-48 bg-gray-100 rounded-lg overflow-hidden">
                      <img
                        ...
                        onClick={() =>
                          window.open(`/api/proxy-image?url=${encodeURIComponent(nft.assetUrl!)}`, "_blank")
                        }
                      />
                    </div>
                  )}
                  ...
                  <div className="space-y-1">
                    {nft.contractAddress && (
                      <p className="text-xs text-muted-foreground">
                        ...
                        <code className="ml-1 bg-gray-100 px-1 rounded">{nft.contractAddress.slice(0, 10)}...</code>
                      </p>
                    )}
                    {nft.tokenId && (
                      <p className="text-xs text-muted-foreground">
                    ...
                    {nft.blockNumber && (
                      <p className="text-xs text-muted-foreground">
                        <span className="font-medium">블록:</span> {nft.blockNumber.toLocaleString()}
                      </p>
                    )}
                    {nft.createdDate && (
                      <p className="text-xs text-muted-foreground">
                  ...
                  <div className="flex gap-2 mt-3">
                    {nft.tokenUrl && (
                      <Button variant="outline" size="sm" className="flex-1" onClick={() => handleViewMetadata(nft)}>
                        <FileText className="mr-1 h-3 w-3" />
                        메타데이터
                      </Button>
                    )}
                    <Button variant="default" size="sm" className="flex-1" onClick={() => handleViewFeatures(nft)}>
