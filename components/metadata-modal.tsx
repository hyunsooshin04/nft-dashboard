            ...
            return (
                <span className="text-green-600">
                    ...
                    <Button
                        ...
                        onClick={() => copyToClipboard(obj, "문자열")}
                    >
                        ...
                        <Tabs defaultValue="structured" className="space-y-4">
                            ...
                            <TabsContent value="structured" className="space-y-4">
                                ...
                                {Object.keys(metadata).filter(
                                    (key) =>
                                        !["name", "description", "image", "external_url", "attributes"].includes(key)
                                ).length > 0 && (
                                    <Card>
                                        <CardHeader>
                                                    ...
                                                    .map(([key, value]) => (
                                                        ...
                                                        >
                                                            ...
                                                            <Button
                                                                ...
                                                                onClick={() =>
                                                                    copyToClipboard(JSON.stringify(value), key)
                                                                }
                                                            >
                                                                {copiedField === key ? (
                                                                    <Check className="h-3 w-3" />
                                    ...
                                    <CardHeader>
                                        <CardTitle className="text-lg flex items-center justify-between">
                                            ...
                                            <Button
                                                ...
                                                size="sm"
                                                onClick={() =>
                                                    copyToClipboard(JSON.stringify(metadata, null, 2), "전체 JSON")
                                                }
                                            >
                                                {copiedField === "전체 JSON" ? (
